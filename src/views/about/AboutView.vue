  ...
  <div class="about-body">
    ...
    <div class="top-box">
      ...
      <div class="right-box">
        ...
        <div class="intro">
          你好，我是一名前端工程師，熱情開朗，喜歡vue也喜歡GSAP，
          擅長與團隊成員溝通協作，共同解決問題並創造優質的產品。工作和生活中都愛嘗試新事物，不斷學習成長。
        </div>
    ...
    <div class="bottom-box">
      ...
      <div class="personal-statement">
        在過去的開發經驗中，能夠獨立完成整體專案，使用Vue3作為主要框架，並運用GSAP做出動態效果，
        從UI/UX設計、網站架構規劃，到前端開發，都能全程參與並順利執行，
